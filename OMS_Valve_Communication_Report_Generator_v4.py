...
# Version 4 - Refactor valve packet mapping and update report field names
...
try:
    ...
    for valve_no in range(1, 9):
        ...
        for dev in devices:
            ...
            if valve is None:
                ...
                if valve["status"] == 1:
                    ...
                    valve["configured_run_time"]
                    ==
                    valve["valve_run_time"]
                ):
                    valve_status = "COMPLETED"
                
                else:
                    valve_status = "FAIL"
                    
                status_row[serial] = valve_status
        ...
        rows.extend([status_row,start_row,config_row,run_row])
        ...
        if choice == "1":
            ...
            for valve_no in range(1, 9):
                ...
                if valve is None:
                    ...
                    print(f"Valve Start Time : "f"{valve['start_time']}")
                    print(f"Configured Run timer : "f"{valve['configured_run_time']}")
                    print(f"Valve Run Timer : "f"{valve['valve_run_time']}"
)
